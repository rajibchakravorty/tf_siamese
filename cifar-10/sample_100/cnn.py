...
def cnn_archi(input_one, dropout_prob, reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope("conv1") as scope:
        net = tf.contrib.layers.conv2d(input_one, 64, [5,5],
                                       stride = [3,3],
    ...
    with tf.variable_scope("conv4") as scope:
        net = tf.contrib.layers.conv2d(net,96, [1, 1],
                                       activation_fn=tf.nn.relu, padding='SAME',
                                       weights_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
    ...
    with tf.variable_scope( "fc1" ) as scope:
        ...
        net = tf.contrib.layers.fully_connected( net , 384, activation_fn = tf.nn.relu,\
